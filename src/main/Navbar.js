      ...
      <div className="w-full h-20 md:h-24 p-4 flex justify-between items-center relative shadow-md z-50">
        <div className="flex  w-1/4 items-center">
          <div className="w-14 md:w-16">
            <img src={Kofe} alt="Kofe" className="cursor-pointer" />
          </div>
          <ul className="hidden md:flex md:justify-between md:w-1/3 md:h-24 items-center">
            <li className="md:h-24 pt-9 px-6 border-b border-transparent hover:border-b-4 hover:border-amber-800 cursor-pointer ml-12 hover:text-amber-800  uppercase font-mono ">
              <Link to="/menu">Menu</Link>
            </li>
            <li className="md:h-24 pt-9 px-4 border-b border-transparent hover:border-b-4 hover:border-amber-800 cursor-pointer hover:text-amber-800  uppercase font-mono">
              Rewards
            </li>
            <li className="md:h-24 pt-9 px-4 border-b border-transparent hover:border-b-4 hover:border-amber-800 cursor-pointer hover:text-amber-800 uppercase font-mono">
              GiftCards
        ...
        <div className="md:hidden">
          <button
            className="px-3 py-1.5  text-2xl font-bold hover:bg-slate-100 hover:rounded-full"
